...
ВИСНОВОК
Під час виконання практичної роботи я ознайомилася з лінійними алгоритмами, навчилася створювати прості програми на C++ з використанням вводу/виводу та виконувати базові арифметичні обчислення. Також закріпила навички роботи з GitHub Desktop для збереження та публікації коду.
